import 'package:opencoolapk/data/model/feed/inlist_feed.dart' show RelationRows;
...
class FeedDetail {
  ...
  List<HotReplyRows> hotReplyRows;
  ...
  FeedDetail.fromJson(Map<String, dynamic> json) {
    ...
    disallowRepost = json['disallow_repost'];
    longLocation = json['long_location'];
    isWhiteFeed = json['is_white_feed'];
    messageBrief = json['message_brief'];
    messageRawInput = json['message_raw_input'];
    messageRawOutput = json['message_raw_output'];
    ...
    userAction = json['userAction'] != null
        ...
        : null;
    if (json['userLikeList'] != null) {
      userLikeList = new List<UserLikeList>();
      json['userLikeList'].forEach((v) {
        userLikeList.add(new UserLikeList.fromJson(v));
      });
    }
    if (json['hotReplyRows'] != null) {
      hotReplyRows = new List<HotReplyRows>();
      json['hotReplyRows'].forEach((v) {
        hotReplyRows.add(new HotReplyRows.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['disallow_repost'] = this.disallowRepost;
    data['long_location'] = this.longLocation;
    data['is_white_feed'] = this.isWhiteFeed;
    data['message_brief'] = this.messageBrief;
    data['message_raw_input'] = this.messageRawInput;
    data['message_raw_output'] = this.messageRawOutput;
    ...
    if (this.userLikeList != null) {
      data['userLikeList'] = this.userLikeList.map((v) => v.toJson()).toList();
    }
    if (this.hotReplyRows != null) {
      data['hotReplyRows'] = this.hotReplyRows.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class UserAction {
  ...
  UserAction(
      {this.like, this.favorite, this.follow, this.collect, this.followAuthor});
  ...
  UserAction.fromJson(Map<String, dynamic> json) {
    ...
    followAuthor = json['followAuthor'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['followAuthor'] = this.followAuthor;
    return data;
  }
}
...
class UserLikeList {
  ...
  UserLikeList({this.uid, this.username, this.userAvatar, this.userInfo});

  UserLikeList.fromJson(Map<String, dynamic> json) {
    uid = json['uid'];
    username = json['username'];
    userAvatar = json['userAvatar'];
    userInfo = json['userInfo'] != null
...
class HotReplyRows {
  ...
  HotReplyRows.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ftype = json['ftype'];
    fid = json['fid'];
    rid = json['rid'];
