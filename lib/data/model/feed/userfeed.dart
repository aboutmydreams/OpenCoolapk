import 'inlist_feed.dart' show ReplyRows, RelationRows;
...
class UserFeed {
  ...
  String mediaInfo;
  ForwardSourceFeed forwardSourceFeed;
  ...
  UserFeed.fromJson(Map<String, dynamic> json) {
    ...
    forwardSourceFeed = json['forwardSourceFeed'] != null
        ? new ForwardSourceFeed.fromJson(json['forwardSourceFeed'])
        : null;
    ...
    targetRow = json['targetRow'] != null
        ...
        : null;
    recentLikeList = json['recentLikeList'].cast<String>();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.forwardSourceFeed != null) {
      data['forwardSourceFeed'] = this.forwardSourceFeed.toJson();
    }
    ...
    if (this.targetRow != null) {
      data['targetRow'] = this.targetRow.toJson();
    }
    data['recentLikeList'] = this.recentLikeList;
    return data;
  }
}

class ForwardSourceFeed {
  int id;
  int type;
  int fid;
  String forwardid;
  ...
  ForwardSourceFeed.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    type = json['type'];
    fid = json['fid'];
    forwardid = json['forwardid'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['picArr'] = this.picArr;
    if (this.relateddata != null) {
      data['relateddata'] = this.relateddata.map((v) => v).toList();
    }
    data['media_info'] = this.mediaInfo;
...
class TargetRow {
  ...
  TargetRow.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    logo = json['logo'];
    title = json['title'];
    url = json['url'];
